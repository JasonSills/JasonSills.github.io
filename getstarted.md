...
<style> .gs-section-01 h3{color: red} .gs-section-01 p{font-size: 30px;} .gs-section-02-03 h2{ color: blue; font-size: 25px } .gs-section-02-03 p{ color: orange; font-size: 50px } </style>
